...
-- Equation(s):
-- \Add1~78_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(10) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(10) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(10))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010111001100001111001100110000000101110011000011110011001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => ALT_INV_IR(10),
	...
	datad => \ALT_INV_state.ex_sub~q\,
	datae => \ALT_INV_state.ex_add~q\,
	combout => \Add1~78_combout\);

\Add1~72\ : cyclonev_lcell_comb
-- Equation(s):
-- \Add1~72_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(4) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(4) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(4))))) ) )
...
-- Equation(s):
-- \Add1~71_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(3) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(3) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(3))))) ) )
...
-- Equation(s):
-- \Add1~81_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(13) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(10) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
...
-- Equation(s):
-- \Add1~80_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(12) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(10) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(12))))) ) )
...
-- Equation(s):
-- \Add1~79_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(11) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(10) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(11))))) ) )
...
-- Equation(s):
-- \Add1~41_sumout\ = SUM(( \Add1~78_combout\ ) + ( (AC(10) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~38\ ))
-- \Add1~42\ = CARRY(( \Add1~78_combout\ ) + ( (AC(10) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~38\ ))
...
-- Equation(s):
-- \Add1~45_sumout\ = SUM(( \Add1~79_combout\ ) + ( (AC(11) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~42\ ))
-- \Add1~46\ = CARRY(( \Add1~79_combout\ ) + ( (AC(11) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~42\ ))
...
-- Equation(s):
-- \Add1~49_sumout\ = SUM(( \Add1~80_combout\ ) + ( (AC(12) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~46\ ))
-- \Add1~50\ = CARRY(( \Add1~80_combout\ ) + ( (AC(12) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~46\ ))
...
-- Equation(s):
-- \Add1~53_sumout\ = SUM(( \Add1~81_combout\ ) + ( (AC(13) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~50\ ))
-- \Add1~54\ = CARRY(( \Add1~81_combout\ ) + ( (AC(13) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~50\ ))
...
-- Equation(s):
-- \Add1~73_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(5) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(5) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(5))))) ) )
...
-- Equation(s):
-- \Add1~17_sumout\ = SUM(( \Add1~72_combout\ ) + ( (AC(4) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~14\ ))
-- \Add1~18\ = CARRY(( \Add1~72_combout\ ) + ( (AC(4) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~14\ ))
...
-- Equation(s):
-- \Add1~21_sumout\ = SUM(( \Add1~73_combout\ ) + ( (AC(5) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~18\ ))
-- \Add1~22\ = CARRY(( \Add1~73_combout\ ) + ( (AC(5) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~18\ ))
...
-- Equation(s):
-- \Add1~75_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(7) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(7) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(7))))) ) )
...
-- Equation(s):
-- \Add1~25_sumout\ = SUM(( \Add1~74_combout\ ) + ( (AC(6) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~22\ ))
-- \Add1~26\ = CARRY(( \Add1~74_combout\ ) + ( (AC(6) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~22\ ))
...
-- Equation(s):
-- \Add1~29_sumout\ = SUM(( \Add1~75_combout\ ) + ( (AC(7) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~26\ ))
-- \Add1~30\ = CARRY(( \Add1~75_combout\ ) + ( (AC(7) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~26\ ))
...
-- Equation(s):
-- \Selector30~2_combout\ = (\altsyncram_component|auto_generated|q_a\(11) & (!\altsyncram_component|auto_generated|q_a\(12) & \Selector30~0_combout\))
...
-- Equation(s):
-- \Selector30~3_combout\ = ((!\altsyncram_component|auto_generated|q_a\(13) & (!\altsyncram_component|auto_generated|q_a\(14) & \Selector30~2_combout\))) # (\state.ex_iload~q\)
...
-- Equation(s):
-- \state~45_combout\ = (!\altsyncram_component|auto_generated|q_a\(13) & (\altsyncram_component|auto_generated|q_a\(14) & \Selector30~2_combout\))
...
PORT MAP (
	...
	datac => \ALT_INV_Selector30~2_combout\,
...
-- Equation(s):
-- \Add1~76_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(8) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(8) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(8))))) ) )
...
-- Equation(s):
-- \Add1~33_sumout\ = SUM(( \Add1~76_combout\ ) + ( (AC(8) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~30\ ))
-- \Add1~34\ = CARRY(( \Add1~76_combout\ ) + ( (AC(8) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~30\ ))
...
-- pragma translate_off
GENERIC MAP (
	mem_init0 => "",
	data_interleave_offset_in_bits => 1,
	data_interleave_width_in_bits => 1,
	init_file => "SimpleDemo.mif",
	init_file_layout => "port_a",
...
-- pragma translate_off
GENERIC MAP (
	mem_init0 => "",
	data_interleave_offset_in_bits => 1,
	data_interleave_width_in_bits => 1,
	init_file => "SimpleDemo.mif",
	init_file_layout => "port_a",
...
-- Equation(s):
-- \Add1~74_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(6) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(6) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(6))))) ) )
...
-- Equation(s):
-- \state~51_combout\ = (\altsyncram_component|auto_generated|q_a\(13) & (!\altsyncram_component|auto_generated|q_a\(14) & \Selector30~2_combout\))
...
-- Equation(s):
-- \Add1~64_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(0) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(0) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(0))))) ) )
...
-- Equation(s):
-- \Add1~1_sumout\ = SUM(( \Add1~64_combout\ ) + ( (AC(0) & (((\state.ex_add~q\) # (\state.ex_sub~q\)) # (\state.ex_addi~q\))) ) + ( \Add1~67_cout\ ))
-- \Add1~2\ = CARRY(( \Add1~64_combout\ ) + ( (AC(0) & (((\state.ex_add~q\) # (\state.ex_sub~q\)) # (\state.ex_addi~q\))) ) + ( \Add1~67_cout\ ))
...
-- Equation(s):
-- \Add1~5_sumout\ = SUM(( \Add1~69_combout\ ) + ( (AC(1) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~2\ ))
-- \Add1~6\ = CARRY(( \Add1~69_combout\ ) + ( (AC(1) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~2\ ))
...
-- pragma translate_off
GENERIC MAP (
	mem_init0 => "",
	data_interleave_offset_in_bits => 1,
	data_interleave_width_in_bits => 1,
	init_file => "SimpleDemo.mif",
	init_file_layout => "port_a",
...
-- Equation(s):
-- \Add1~69_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(1) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(1) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(1))))) ) )
...
-- Equation(s):
-- \Add1~9_sumout\ = SUM(( \Add1~70_combout\ ) + ( (AC(2) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~6\ ))
-- \Add1~10\ = CARRY(( \Add1~70_combout\ ) + ( (AC(2) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~6\ ))
...
-- Equation(s):
-- \Add1~70_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(2) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(2) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
...
-- Equation(s):
-- \Add1~13_sumout\ = SUM(( \Add1~71_combout\ ) + ( (AC(3) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~10\ ))
-- \Add1~14\ = CARRY(( \Add1~71_combout\ ) + ( (AC(3) & (((\state.ex_addi~q\) # (\state.ex_sub~q\)) # (\state.ex_add~q\))) ) + ( \Add1~10\ ))
...
-- Equation(s):
-- \Add1~37_sumout\ = SUM(( \Add1~77_combout\ ) + ( (AC(9) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~34\ ))
-- \Add1~38\ = CARRY(( \Add1~77_combout\ ) + ( (AC(9) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~34\ ))
...
-- pragma translate_off
GENERIC MAP (
	mem_init0 => "",
	data_interleave_offset_in_bits => 1,
	data_interleave_width_in_bits => 1,
	init_file => "SimpleDemo.mif",
	init_file_layout => "port_a",
...
-- Equation(s):
-- \Add1~77_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(9) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(9) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(9))))) ) )
...
-- Equation(s):
-- \Add1~83_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(15) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(10) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
...
-- Equation(s):
-- \Add1~82_combout\ = ( \state.ex_add~q\ & ( !\altsyncram_component|auto_generated|q_a\(14) $ (((!\state.ex_addi~q\ & !\state.ex_sub~q\))) ) ) # ( !\state.ex_add~q\ & ( (!\state.ex_sub~q\ & (IR(10) & ((\state.ex_addi~q\)))) # (\state.ex_sub~q\ & 
-- (((!\altsyncram_component|auto_generated|q_a\(14))))) ) )
...
-- Equation(s):
-- \Add1~57_sumout\ = SUM(( \Add1~82_combout\ ) + ( (AC(14) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~54\ ))
-- \Add1~58\ = CARRY(( \Add1~82_combout\ ) + ( (AC(14) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~54\ ))
...
-- Equation(s):
-- \Add1~61_sumout\ = SUM(( \Add1~83_combout\ ) + ( (AC(15) & (((\state.ex_sub~q\) # (\state.ex_addi~q\)) # (\state.ex_add~q\))) ) + ( \Add1~58\ ))
...
-- Equation(s):
-- \state~39_combout\ = ( \Selector30~0_combout\ & ( (!\altsyncram_component|auto_generated|q_a\(11) & (!\altsyncram_component|auto_generated|q_a\(12) & (\altsyncram_component|auto_generated|q_a\(13) & !\altsyncram_component|auto_generated|q_a\(14)))) ) )
...
-- Equation(s):
-- \state~38_combout\ = (\altsyncram_component|auto_generated|q_a\(13) & (\altsyncram_component|auto_generated|q_a\(14) & \Selector30~2_combout\))
